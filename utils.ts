...
export const translations = {
  zh: {
    ...
    modeGifCrop: "GIF裁剪",
    modeWpUpload: "WP压缩上传",
    wpTitle: "WordPress 图片压缩上传插件",
    wpSubtitle: "专为 Gutenberg 编辑器开发，原生压缩 + WebP 转换 + 自动上传。",
    wpFeature1: "原生压缩：利用浏览器原生技术，无需服务器处理。",
    wpFeature2: "WebP 转换：自动将图片转换为 WebP 格式，减小体积。",
    wpFeature3: "自动插入：上传后自动在光标处插入 core/image 块。",
    wpFeature4: "无缝集成：在侧边栏增加专属面板，不影响原生流程。",
    wpGithub: "前往 GitHub 下载",
    cropRatio: "比例",
    ratioFree: "自由",
    ratio11: "1:1",
    ratio169: "16:9",
  ...
  en: {
    ...
    modeWpUpload: "WP Image Compress Upload",
    wpTitle: "WP Image Compress Upload Plugin",
    wpSubtitle: "Built for Gutenberg editor, native compression + WebP conversion + auto upload.",
    wpFeature1: "Native Compression: Uses browser technology, no server processing.",
    wpFeature2: "WebP Conversion: Automatically converts images to WebP format.",
    wpFeature3: "Auto Insertion: Automatically inserts core/image block after upload.",
    wpFeature4: "Seamless Integration: Dedicated sidebar panel, doesn't break native flow.",
    wpGithub: "Download on GitHub",
    cropRatio: "Ratio",
    ratioFree: "Free",
    ratio11: "1:1",
    ratio169: "16:9",
